...
const TextSidebar = ({ isOpen }: Props) => {
  ...
  const [colorInput, setColorInput] = React.useState<string>("#ffffff");
      ...
      <div className="p-4 flex flex-col gap-10 overflow-y-auto max-h-[calc(100vh-8rem)]">
          ...
          >
            ...
            <SelectContent className="bg-black/90 border-white/10">
              {fontFamilies.map((font) => (
                ...
                >
                  <span title={font} style={{ fontFamily: font }}>
                    {font.split(".")[0]}
                  </span>
                </SelectItem>
              ))}
        ...
        <div className="space-y-2">
          ...
          <Slider
            ...
            onValueChange={(value) =>
              updateTextProperty("fontWeight", value[0])
            }
            min={100}
            max={900}
            step={100}
